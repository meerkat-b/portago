-- portago — Neovim config for a portable Go IDE
-- Based on kickstart.nvim, customized for Go development.
...
-- Disable netrw (Vim's built-in file explorer) to prevent conflicts with nvim-tree
...
require('lazy').setup({
    ...
    config = function()
      ...
      require('tokyonight').setup {
        ...
        on_highlights = function(hl, c)
          -- Make normal text brighter white for more contrast
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      -- Enable for the current buffer if its filetype is already set
